...
/**
 * This is the item provider adapter for a {@link studyprogramme.CourseSlot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CourseSlotItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CourseSlot_course_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CourseSlot_course_feature", "_UI_CourseSlot_type"),
				 StudyprogrammePackage.Literals.COURSE_SLOT__COURSE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_CourseSlot_type");
	}
